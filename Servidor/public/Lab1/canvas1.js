let canvas1 = document.getElementById("canvas1")
 ...
 function Circulos() {
  ...
  [30, 50, 70].forEach(r => {
  ctx1.beginPath();
    ctx1.arc(150, 150, 70, 5.5, Math.PI * 2);
      ctx1.stroke();
  });
  ...
  let ctx2 = canvas2.getContext("2d")
   ...
   desenharArvore(260, 200);
   
   function desenharRio() {
    ctx2.fillStyle = 'dodgerblue';

    // Parte vertical
    ctx2.fillRect(0, 200, 40, 60);
  
    // Parte horizontal
    ctx2.fillRect(0, 260, 120, 80);
  
    // Curva superior esquerda (virada para a esquerda)
    ctx2.beginPath();
    ctx2.moveTo(0, 200);
    ctx2.arc(0, 200, 40, Math.PI * 1.5, Math.PI * 2); // topo arredondado
    ctx2.fill();
